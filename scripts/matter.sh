...
sudo -A $HOME/.config/matter/matter.py -i arch folder arch -ic $color -bg $background -fg $background -hl $color -ff ~/.fonts/Roboto-Regular.ttf -fn Roboto Regula r -fs 16
