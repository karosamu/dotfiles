...
sudo -A $HOME/.config/matter/matter.py -i arch arch folder arch arch -ic $color -bg $background -fg $background -hl $color -ff ~/.fonts/Roboto-Regular.ttf -fn Roboto Regula r -fs 16
